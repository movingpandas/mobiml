...
If you are looking to contribute to the *MobiML* codebase, the best place to
start is the [GitHub "issues" tab](https://github.com/movingpandas/mobiml/issues).
...
The code is hosted on [GitHub](https://github.com/movingpandas/mobiml),
